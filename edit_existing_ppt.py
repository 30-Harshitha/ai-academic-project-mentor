...
target_pptx_1 = r'C:\Users\Harshita\Downloads\AI Academic Project Tracking Platform.pptx'
target_pptx_2 = r'C:\Users\Harshita\Downloads\AI Academic Project Tracking Platform (1).pptx'
new_spring_pptx = r'C:\Users\Harshita\Downloads\NEW SPRING\AI_Academic_Project_Mentor_25_Slide_Presentation.pptx'
...
def build_full_25_presentation():
    prs = Presentation()
...
prs = build_full_25_presentation()
prs.save(target_pptx_1)
prs.save(target_pptx_2)
prs.save(new_spring_pptx)

print('SUCCESSFULLY UPDATED BOTH DIRECTORY PRESENTATION FILES:')
print(target_pptx_1)
print(target_pptx_2)
print(new_spring_pptx)
